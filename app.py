    ...
    if st.button("Send", key="contact_submit"):
        if contact_email and message:
            try:
                ...
                msg['To'] = 'piyushkashyap3247@gmail.com'  # Replace with your support email
...
footer_text = st.markdown("""<p style='text-align: center;'>Developed by Piyush Kashyap! &copy; 2024</p>""", unsafe_allow_html=True)   
